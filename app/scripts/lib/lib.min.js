...
function Promise(){var n=riot.observable(this);$.map(["done","fail","always"],function(t){n[t]=function(i){return n[$.isFunction(i)?"on":"trigger"](t,i)}})}(function(n){"use strict";function u(n){return n==null?"":(n+"").replace(/[&\"<>]/g,function(n){return r[n]})}n.observable=function(n){var t={},i=[].slice;return n.on=function(i,r){return typeof r=="function"&&i.replace(/\S+/g,function(n,i){(t[n]=t[n]||[]).push(r);r.typed=i>0}),n},n.off=function(i,r){var f,u,e;if(i==="*")t={};else if(r)for(f=t[i],u=0;e=f&&f[u];++u)e===r&&(f.splice(u,1),u--);else i.replace(/\S+/g,function(n){t[n]=[]});return n},n.one=function(t,i){i&&(i.one=!0);return n.on(t,i)},n.trigger=function(r){for(var e=i.call(arguments,1),o=t[r]||[],f=0,u;u=o[f];++f)u.busy||(u.busy=!0,u.apply(n,u.typed?[r].concat(e):e),u.one&&(o.splice(f,1),f--),u.busy=!1);return n},n};var t={},i={"\\":"\\\\","\n":"\\n","\r":"\\r","'":"\\'"},r={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};n.render=function f(n,t){var i=/\W/.test(n)?new Function("obj","var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('"+n.replace(/[\r\t\n]/g," ").split("{{").join("\t").replace(/((^|\}\})[^\t]*)'/g,"$1\r").replace(/\t=(.*?)\}\}/g,"',$1,'").split("\t").join("');").split("}}").join("p.push('").split("\r").join("\\'")+"');}return p.join('');"):cache[n]=cache[n]||f(document.getElementById(n).innerHTML);return t?i(t):i};n.renderOrg=function(n,r,f){return f===!0&&(f=u),n=n||"",(t[n]=t[n]||new Function("_","e","return '"+n.replace(/[\\\n\r']/g,function(n){return i[n]}).replace(/{{\s*([\w\.]+)\s*}}/g,"' + (e?e(_.$1,'$1'):_.$1||(_.$1==null?'':_.$1)) + '")+"'"))(r,f)},function(){function t(n){n=n.type?location.hash:n;n!==r&&u.trigger("pop",n);r=n}if(typeof window!="undefined"){var r,u=n.observable({}),f=window.addEventListener,i=document;f?(f("popstate",t,!1),i.addEventListener("DOMContentLoaded",t,!1)):i.attachEvent("onreadystatechange",function(){i.readyState==="complete"&&t("")});n.route=function(n){if(typeof n=="function")return u.on("pop",n);history.pushState&&history.pushState(0,0,n);t(n)}}}();typeof exports=="object"?module.exports=n:typeof define=="function"&&define.amd?define(function(){return n}):window.riot=n})({});
/**
 * @license
